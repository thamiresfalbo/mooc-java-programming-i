    ...
    public void games1() {
        ...
        assertTrue(
                "With the file:\n" + textToWriteToFile
                        ...
                        + io.getSysOut(),
                lines(io.getSysOut()).stream().filter(l -> l.contains("Games: 1")).count() == 1);
    }
    ...
    public void games2() {
        ...
        assertTrue(
                "With the file:\n" + textToWriteToFile
                        ...
                        + io.getSysOut(),
                lines(io.getSysOut()).stream().filter(l -> l.contains("Games: 2")).count() == 1);
    }
    ...
    public void games3() {
        ...
        assertTrue(
                "With the file:\n" + textToWriteToFile
                        ...
                        + io.getSysOut(),
                lines(io.getSysOut()).stream().filter(l -> l.contains("Games: 0")).count() == 1);
    }
    ...
    public void winsAndLosses1() {
        ...
        assertTrue(
                "With the file:\n" + textToWriteToFile
                        ...
                        + io.getSysOut(),
                lines(io.getSysOut()).stream().filter(l -> l.contains("Wins: 1")).count() == 1);
        assertTrue(
                "With the file:\n" + textToWriteToFile
                        + "\nWhen searcing for mice the output should have the line \" Losses: 0\".\nthe output was:\n"
                        + io.getSysOut(),
                lines(io.getSysOut()).stream().filter(l -> l.contains("Losses: 0")).count() == 1);
    }
    ...
    public void winsAndLosses3() {
        ...
        assertTrue(
                "With the file:\n" + textToWriteToTheFile
                        ...
                        + io.getSysOut(),
                lines(io.getSysOut()).stream().filter(l -> l.contains("Wins: 0")).count() == 1);
        assertTrue("With the file:\n" + textToWriteToTheFile
